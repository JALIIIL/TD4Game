                ...
                for (byte element : line.getBytes(StandardCharsets.UTF_8)){
                    switch (element){
                        ...
                        case 'R' : environment.add(new SolidSprite(imageRock,columnNumber*imageRockWidth,
                            ...
                            break;
                        case 'P':
                            environment.add(new Trap(imageTrap, columnNumber * imageTrap.getWidth(null),
                                    lineNumber * imageTrap.getHeight(null), imageTrap.getWidth(null), imageTrap.getHeight(null),10));
                            break;
                    }
                    columnNumber++;
                }
